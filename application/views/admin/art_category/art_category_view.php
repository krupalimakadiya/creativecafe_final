    ...
    <section class="content-header">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <p align="right">
                    <a href="<?php echo base_url(); ?>admin/category/add_category"><button class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;Add records</button></a> &nbsp;
                    <a href="<?php echo base_url(); ?>admin/category/import"><button class="btn btn-primary"><i class="glyphicon glyphicon-import"></i>&nbsp;Imports</button></a> &nbsp;
                    <a href="<?php echo base_url(); ?>admin/category/export"><button class="btn btn-primary"><i class="glyphicon glyphicon-export"></i>&nbsp;Exports</button></a></p>
                                    ...
                                    <td> 
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu"> <!-- class dropdown-menu -->
                                                ...
                                                <li><a href="<?php echo base_url(); ?>admin/category/edit_data/<?php echo $category->art_category_id; ?>" onclick="return confirm('you want to edit...........')"><i class="fa fa-edit"></i><label>Edit</label></a></li>
                                                <li><a href="<?php echo base_url(); ?>admin/category/delete/<?php echo $category->art_category_id; ?>" onclick="return confirm('you want to delete...........')"><i class="fa fa-trash"></i><label>Delete</label></a></li>
                                                <li><?php
                                                    if ($category->status == '0') {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/category/update_status_active/<?php echo $category->art_category_id; ?>"><i class="glyphicon glyphicon-ok" style="color:green"></i><label>Active</label></a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/category/update_status_deactive/<?php echo $category->art_category_id; ?>"><i class="glyphicon glyphicon-remove" style="color:red"></i><label>Deactive</label></a>
                                                        <?php
                                                    }
                                                    ?></li>
                                            </ul>

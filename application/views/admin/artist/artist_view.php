                                            ...
                                            <ul class="dropdown-menu" role="menu"> <!-- class dropdown-menu -->
                                                ...
                                                <li><?php
                                                    if ($artist->status == '0') {
                                                        ...
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/artist/update_status_deactive/<?php echo $artist->artist_id; ?>"><i class="glyphicon glyphicon-remove" style="color:red"></i><label>Deactive</label></a>
                                                        <?php
                                                    }
                                                    ?></li>
                                            </ul>

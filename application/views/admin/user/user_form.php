    ...
    <section class="content-header">
        ...
        <div class="box box-info">
            <div class="box-header with-border box-primary" >
                ...
                <a href="<?php echo base_url(); ?>admin/user" class="btn btn-primary pull-right">
            ...
            <div class="box-body">
                ...
                if (isset($update_data)) {
                    ...
                    <form name="userfrm" method="POST" action="<?php echo base_url(); ?>admin/user/editp" role="form" >
                    ...
                    <form name="userfrm" method="POST" action="<?php echo base_url('admin/user/addp'); ?>" role="form" >
                        <div class="form-group">
                            <label>First name</label>
...
<script>
    $("document").ready(function () {
        ...
        $("#country_id").change(function () {
            ...
            var id = $(this).val();
            $.ajax({
                url: "<?php echo base_url(); ?>user/drop_state",
                type: "POST",
                data: {country_id: id},
    ...
    $("document").ready(function () {
        ...
        $("#state_id").change(function () {
            ...
            var id = $(this).val();
            $.ajax({
                url: "<?php echo base_url(); ?>user/drop_city",
                type: "POST",
                data: {state_id: id},
                success: function (result) {
                    //alert(result);
